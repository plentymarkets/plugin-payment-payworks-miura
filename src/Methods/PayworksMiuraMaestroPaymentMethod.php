 ...
 */
class PayworksMiuraMaestroPaymentMethod extends PaymentMethodService
{
    /**
    ...
    {
        if( trim($configRepository->get('PayworksMiura.miuramaestro-merchant_identifier')) != '' && trim($configRepository->get('PayworksMiura.miuramaestro-merchant_secret_key')) !='')
        {
            return true;
        }
